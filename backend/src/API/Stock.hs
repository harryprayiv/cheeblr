...
type StockAPI =
  "stock" :>
    ...
    :<|> "queue" :> "stream"
           ...
           :> Raw
    :<|> "pull" :> Capture "id" UUID
           :> AuthHeader
           :> Get '[JSON] PullRequestDetail
    :<|> "pull" :> Capture "id" UUID :> "accept"
           :> AuthHeader
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "start"
           :> AuthHeader
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "fulfill"
           :> AuthHeader
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "issue"
           :> AuthHeader
           :> ReqBody '[JSON] IssueReport
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "retry"
           :> AuthHeader
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "message"
           :> AuthHeader
           :> ReqBody '[JSON] NewMessage
           :> Post '[JSON] MutationResponse
    :<|> "pull" :> Capture "id" UUID :> "messages"
           :> AuthHeader
