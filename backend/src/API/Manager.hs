...
import API.Transaction   (DailyReportRequest, DailyReportResult,
                           ComplianceReportRequest, ComplianceReportResult)
...
type ManagerAPI =
  "manager" :>
    ...
    :<|> "override" :> "void" :> Capture "txId" UUID
           :> AuthHeader
           :> ReqBody '[JSON] OverrideRequest
           :> Post '[JSON] MutationResponse
    :<|> "override" :> "discount" :> Capture "txId" UUID
           :> AuthHeader
           :> ReqBody '[JSON] OverrideRequest
           :> Post '[JSON] MutationResponse
    )
